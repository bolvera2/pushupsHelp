...
$H_A$: The average pushups of line players is not statistically different than that of skill players.
...
The null hypothesis is $H_0$: There is no difference between the average pushups of line vs skill players

The box plot indicates there is a difference between pushups and postions of skill and line players. As the skill players have a higher pushup count even from a minimum than the average line player. This shows that there is quite a difference significantly between the pushups from the skill players and the line players

A t-test of differnce in means gave a p-value of 9.421e-06, which is less than than, so we reject the null hypothesis and conclude we have evidence of a difference in average pushups between players in the two positions.
